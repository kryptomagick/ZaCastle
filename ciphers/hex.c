...
void hexCipherInit(struct hexCipherState *state) {
    hexInit(&state->hx);
    state->keylen = 52;
    state->ivlen = 52;
    state->blocklen = 26;
    state->inputlen = state->hx.inputlen;
    state->hashlen = state->hx.hashlen;
}
...
void hexCrossAdd(struct hexState *state) {
    state->H[0][0] = modadd(state->H[0][0], state->H[2][0], 26);
    state->H[0][1] = modadd(state->H[0][1], state->H[2][1], 26);
    state->H[0][2] = modadd(state->H[0][2], state->H[2][2], 26);
    state->H[0][3] = modadd(state->H[0][3], state->H[2][3], 26);
    state->H[0][4] = modadd(state->H[0][4], state->H[2][4], 26);
    state->H[0][5] = modadd(state->H[0][5], state->H[2][5], 26);
    state->H[0][6] = modadd(state->H[0][6], state->H[2][6], 26);
    state->H[0][7] = modadd(state->H[0][7], state->H[2][7], 26);
    state->H[0][8] = modadd(state->H[0][8], state->H[2][8], 26);
    state->H[0][9] = modadd(state->H[0][9], state->H[2][9], 26);
    state->H[0][10] = modadd(state->H[0][10], state->H[2][10], 26);
    state->H[0][11] = modadd(state->H[0][11], state->H[2][11], 26);
    state->H[0][12] = modadd(state->H[0][12], state->H[2][12], 26);
    state->H[1][0] = modadd(state->H[1][0], state->H[3][0], 26);
    state->H[1][1] = modadd(state->H[1][1], state->H[3][1], 26);
    state->H[1][2] = modadd(state->H[1][2], state->H[3][2], 26);
    state->H[1][3] = modadd(state->H[1][3], state->H[3][3], 26);
    state->H[1][4] = modadd(state->H[1][4], state->H[3][4], 26);
    state->H[1][5] = modadd(state->H[1][5], state->H[3][5], 26);
    state->H[1][6] = modadd(state->H[1][6], state->H[3][6], 26);
    state->H[1][7] = modadd(state->H[1][7], state->H[3][7], 26);
    state->H[1][8] = modadd(state->H[1][8], state->H[3][8], 26);
    state->H[1][9] = modadd(state->H[1][9], state->H[3][9], 26);
    state->H[1][10] = modadd(state->H[1][10], state->H[3][10], 26);
    state->H[1][11] = modadd(state->H[1][11], state->H[3][11], 26);
    state->H[1][12] = modadd(state->H[1][12], state->H[3][12], 26);
    state->H[2][0] = modadd(state->H[2][0], state->H[0][0], 26);
    state->H[2][1] = modadd(state->H[2][1], state->H[0][1], 26);
    state->H[2][2] = modadd(state->H[2][2], state->H[0][2], 26);
    state->H[2][3] = modadd(state->H[2][3], state->H[0][3], 26);
    state->H[2][4] = modadd(state->H[2][4], state->H[0][4], 26);
    state->H[2][5] = modadd(state->H[2][5], state->H[0][5], 26);
    state->H[2][6] = modadd(state->H[2][6], state->H[0][6], 26);
    state->H[2][7] = modadd(state->H[2][7], state->H[0][7], 26);
    state->H[2][8] = modadd(state->H[2][8], state->H[0][8], 26);
    state->H[2][9] = modadd(state->H[2][9], state->H[0][9], 26);
    state->H[2][10] = modadd(state->H[2][10], state->H[0][10], 26);
    state->H[2][11] = modadd(state->H[2][11], state->H[0][11], 26);
    state->H[2][12] = modadd(state->H[2][12], state->H[0][12], 26);
    state->H[3][0] = modadd(state->H[3][0], state->H[1][0], 26);
    state->H[3][1] = modadd(state->H[3][1], state->H[1][1], 26);
    state->H[3][2] = modadd(state->H[3][2], state->H[1][2], 26);
    state->H[3][3] = modadd(state->H[3][3], state->H[1][3], 26);
    state->H[3][4] = modadd(state->H[3][4], state->H[1][4], 26);
    state->H[3][5] = modadd(state->H[3][5], state->H[1][5], 26);
    state->H[3][6] = modadd(state->H[3][6], state->H[1][6], 26);
    state->H[3][7] = modadd(state->H[3][7], state->H[1][7], 26);
    state->H[3][8] = modadd(state->H[3][8], state->H[1][8], 26);
    state->H[3][9] = modadd(state->H[3][9], state->H[1][9], 26);
    state->H[3][10] = modadd(state->H[3][10], state->H[1][10], 26);
    state->H[3][11] = modadd(state->H[3][11], state->H[1][11], 26);
    state->H[3][12] = modadd(state->H[3][12], state->H[1][12], 26);
}
